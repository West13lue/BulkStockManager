...
(function() {
  ...
  var translations = {
    fr: {
      "manualSales.cancelLine": "Annuler cette ligne (restitue le stock)",
      "manualSales.cancelOrder": "Annuler la vente (restituer le stock)",
      "manualSales.cancelOrderConfirm": "Annuler cette vente manuelle ?",
      "manualSales.cancelLineConfirm": "Annuler cette ligne ?",
      "manualSales.cancelRestitue": "Le stock sera recredite de",
      "manualSales.cancelConfirmBtn": "Annuler la vente",
      "manualSales.cancelError": "Echec de l'annulation",
      "manualSales.cancelDone": "Vente annulee, stock restitue",
      "action.add": "Ajouter",
      ...
      "analytics.manualSales": "Ventes manuelles",
      "manualSales.noSales": "Aucune vente manuelle",
      "manualSales.noSalesDesc": "Les ventes realisees en boutique ou en livraison apparaitront ici.",
      "manualSales.count": "Ventes",
      "manualSales.revenue": "CA",
      "manualSales.cost": "Cout",
      "manualSales.margin": "Marge",
      "manualSales.volume": "Volume",
      "manualSales.date": "Date",
      "manualSales.product": "Produit",
      "manualSales.qty": "Quantite",
      "analytics.ordersRecap": "Recap commandes",
      "ordersDebug.noOrders": "Aucune commande dans cette periode",
      "ordersDebug.detectDups": "Detecter doublons",
      "ordersDebug.noDups": "Aucun doublon trouve",
      "ordersDebug.cleaning": "Nettoyage en cours...",
      "ordersDebug.cleanupTitle": "Nettoyage des analytics",
      "ordersDebug.onlyDups": "Supprimer doublons seulement",
      "ordersDebug.dupsAndSelected": "Supprimer doublons + selection",
      ...
      "analytics.treasury": "Trésorerie",
      "analytics.treasury.cached": "cache 15min",
      "analytics.treasury.cashPlusStock": "cash + stock",
      "analytics.treasury.credits": "Encaissements",
      "analytics.treasury.currentBalance": "Solde Qonto",
      "analytics.treasury.dailyCashflow": "Cashflow journalier",
      "analytics.treasury.debits": "Décaissements",
      "analytics.treasury.gap": "Gap (frais + lag)",
      "analytics.treasury.loading": "Chargement Qonto...",
      "analytics.treasury.movements": "mouvements",
      "analytics.treasury.netVariation": "Variation nette",
      "analytics.treasury.noMovements": "Aucun mouvement sur la période",
      "analytics.treasury.notConfiguredHint": "Ajoutez QONTO_LOGIN et QONTO_SECRET_KEY dans les variables d'environnement Render pour activer cette vue.",
      "analytics.treasury.notConfiguredTitle": "Qonto non configuré",
      "analytics.treasury.onPeriod": "sur la période",
      "analytics.treasury.openQonto": "Ouvrir Qonto",
      "analytics.treasury.patrimoineEvolution": "Évolution du patrimoine",
      "analytics.treasury.patrimoineEvolutionHint": "Reconstitué depuis l'état actuel + cashflow + mouvements stock",
      "analytics.treasury.perDay": "jour",
      "analytics.treasury.period": "Période",
      "analytics.treasury.processorGapNote": "Approximation : les payouts Shopify Payments arrivent avec 2-3j de délai et incluent les remboursements. Plus la période est courte, moins le chiffre est fiable.",
      "analytics.treasury.processorGapTitle": "Frais payment processor (Shopify Payments)",
      "analytics.treasury.product": "produit",
      "analytics.treasury.products": "produits",
      "analytics.treasury.runRate": "Run-rate mensuel",
      "analytics.treasury.shopifyGross": "CA brut Shopify",
      "analytics.treasury.shopifyPayouts": "Encaissé Qonto (Shopify)",
      "analytics.treasury.stockValue": "Valeur stock (CMP)",
      "analytics.treasury.topCredits": "Top encaissements",
      "analytics.treasury.topDebits": "Top décaissements",
      "analytics.treasury.totalAssets": "Patrimoine total",
      "analytics.treasury.transaction": "transaction",
      "analytics.treasury.transactions": "transactions",
      "analytics.treasury.transactionsFetched": "transactions chargées",
      "analytics.treasury.unavailableTitle": "API Qonto indisponible",
      "analytics.treasury.updatedAt": "Mise à jour",
      ...
      "dashboard.latestOrder.empty": "Aucune commande Shopify récente.",
      "dashboard.latestOrder.emptyHint": "Les étiquettes apparaîtront ici dès qu'une commande arrivera.",
      "dashboard.latestOrder.error": "Impossible de charger la dernière commande.",
      "dashboard.latestOrder.newOrder": "Nouvelle commande prête à étiqueter",
      "dashboard.latestOrder.noProducts": "Produits introuvables dans le catalogue local.",
      "dashboard.latestOrder.notInCatalog": "absent du catalogue",
      "dashboard.latestOrder.pouchMany": "pochons",
      "dashboard.latestOrder.pouchOne": "pochon",
      "dashboard.latestOrder.printBtn": "Imprimer les étiquettes",
      "dashboard.latestOrderLabels": "Étiquette dernière commande",
      ...
      "dashboard.qontoBalance": "Solde Qonto",
      ...
      "filter.noMatch": "Aucun produit ne correspond aux filtres actifs.",
      "filter.reset": "Réinitialiser",
      "filter.status": "Statut",
      "filter.statusCritical": "Rupture / critique",
      "filter.statusLow": "Stock bas",
      "filter.statusOk": "Stock OK",
      ...
      "labels.title": "Imprimer des etiquettes",
      "labels.product": "Produit",
      "labels.lot": "Lot",
      "labels.allLots": "Tous les lots actifs",
      "labels.quantity": "Nombre d'etiquettes",
      "labels.weight": "Poids par pochon",
      "labels.weightAuto": "Auto depuis lot",
      "labels.format": "Format",
      "labels.price": "Prix de vente",
      "labels.optional": "Optionnel",
      "labels.customLine": "Ligne personnalisee",
      "labels.showQR": "QR Code tracabilite",
      "labels.showPrice": "Afficher le prix",
      "labels.showSupplierRef": "Ref. fournisseur",
      "labels.selectProduct": "Selectionnez un produit pour generer l'apercu",
      "labels.preview": "Apercu",
      "labels.print": "Imprimer",
      "labels.printTitle": "Etiquettes",
      "labels.labelCount": "etiquette(s)",
      "labels.previewNote": "Apercu limite a 4 etiquettes. Les {count} seront imprimees.",
      "labels.popupBlocked": "Popup bloquee - autorisez les popups pour imprimer",
      "labels.addLabel": "Ajouter",
      "labels.giftAdd": "Pochon cadeau",
      "labels.giftBadge": "Pochon cadeau",
      "labels.giftHint": "Le cout (CMP) sera compte dans la marge de la commande, sans CA. Le stock sera decremente a l'impression.",
      "labels.giftPriceDisabled": "Prix non applicable sur un pochon cadeau",
      "labels.giftSaved": "{count} ligne(s) cadeau enregistree(s)",
      "labels.giftFailed": "{count} ligne(s) cadeau non enregistree(s)",
      "labels.giftNoOrder": "Pochon cadeau ignore (commande inconnue).",
      "labels.labelNum": "Etiquette",
      "labels.previewTotal": "{count} etiquette(s) au total sur la feuille",
      "labels.productTypes": "produits differents",
      ...
      "msg.stockUpdated": "Stock mis à jour",
      "msg.success": "Succes",
      "msg.syncing": "Sync...",
      ...
      "orders.uploadInvoice": "Deposer une facture d'achat",
      "orders.uploadFormats": "PDF - Le texte sera extrait et analyse automatiquement",
      "orders.analyzing": "Extraction du texte...",
      "orders.invoiceAnalyzed": "Facture analysee - {count} ligne(s) detectee(s)",
      "orders.analysisFailed": "Analyse echouee",
      "orders.manualEntry": "Saisissez les lignes manuellement ci-dessous.",
      "orders.imageUploaded": "Image chargee. Saisissez les lignes manuellement.",
      "orders.pdfLibError": "Impossible de charger le lecteur PDF.",
      "orders.showExtracted": "Voir le texte extrait",
      ...
      "products.confirmDelete": "Supprimer definitivement ce produit du stock ?",
      "products.confirmDeleteWarn": "Cette action est irreversible. L'historique des mouvements sera conserve.",
      "products.deleted": "Produit supprime du stock",
      "products.selected": "selectionne(s)",
      "products.deleteSelected": "Supprimer la selection",
      "products.confirmDeleteMultiple": "Supprimer {count} produit(s) du stock ?",
      "products.deletingMultiple": "Suppression en cours...",
      "products.deletedCount": "produit(s) supprime(s)",
      "products.note": "Note",
      ...
      "sale.title": "Vente manuelle",
      "sale.manualInfo": "Vente hors Shopify",
      "sale.manualDesc": "Enregistrez une vente realisee en boutique, marche ou livraison. Le stock sera deduit et la vente comptabilisee dans les statistiques.",
      "sale.product": "Produit",
      "sale.quantity": "Quantite vendue",
      "sale.sellingPrice": "Prix de vente total",
      "sale.customer": "Client",
      "sale.customerPlaceholder": "Nom du client ou ref. commande",
      "sale.note": "Note",
      "sale.notePlaceholder": "Ex: Vente comptoir, marche, livraison...",
      "sale.confirm": "Enregistrer la vente",
      "sale.costPrice": "Cout de revient",
      "sale.margin": "Marge",
      "sale.success": "Vente enregistree",
      "sale.products": "Produits vendus",
      "sale.addProduct": "Ajouter un produit",
      "sale.addAtLeastOne": "Ajoutez au moins un produit",
      "sale.qtyMissing": "Quantite manquante sur la ligne : ",
      "sale.productMissing": "Selectionne un produit dans chaque ligne",
      "sale.quantityPh": "Qte",
      "sale.totalLockedTitle": "Total calcule depuis les prix par ligne",
      "sale.priceRequired": "Saisissez le prix de vente",
      "sale.stockWarning": "Stock insuffisant pour certains produits :",
      "sale.continueAnyway": "Continuer quand meme ?",
      "sale.processing": "Enregistrement...",
      "sale.printLabels": "Etiquettes de la commande",
      "sale.labelsReady": "{count} etiquette(s) prete(s) pour impression.",
      "sale.skipLabels": "Passer",
      "sale.insufficientStock": "Stock insuffisant ({stock}) pour la quantite demandee ({qty}). Continuer ?",
      "dashboard.manualSale": "Vente manuelle",
      ...
      "settings.fullBackup": "Backup complet",
      "settings.snapshots": "Points de restauration",
      "settings.createSnapshot": "Creer un point",
      "settings.viewSnapshots": "Voir / Restaurer",
      "settings.snapshotLabel": "Nom du point de restauration (optionnel) :",
      "settings.creatingSnapshot": "Creation du point...",
      "settings.snapshotCreated": "Point de restauration cree !",
      "settings.noSnapshots": "Aucun point de restauration disponible.",
      "settings.noSnapshotsHint": "Creez un point pour pouvoir revenir en arriere.",
      "settings.restoreSnapshot": "Restaurer",
      "settings.confirmRollback": "Restaurer les donnees au point :",
      "settings.confirmRollbackWarn": "Un point de sauvegarde automatique sera cree avant la restauration. Continuer ?",
      "settings.rollingBack": "Restauration en cours...",
      "settings.rollbackSuccess": "Donnees restaurees avec succes !",
      "settings.confirmDeleteSnapshot": "Supprimer ce point de restauration ?",
      "settings.snapshotDeleted": "Point supprime",
      "settings.dangerZone": "Zone dangereuse",
      "settings.dangerZoneDesc": "Ces actions sont irreversibles et supprimeront definitivement vos donnees.",
      "settings.resetAllData": "Reinitialiser toutes les donnees",
      "settings.confirmResetAll1": "ATTENTION : Cette action va supprimer TOUTES vos donnees (produits, stock, mouvements, parametres).\n\nUn point de restauration automatique sera cree avant la suppression.\n\nEtes-vous sur ?",
      "settings.confirmResetAll2": "Pour confirmer, tapez RESET en majuscules :",
      "settings.resetCancelled": "Reinitialisation annulee",
      "settings.resettingAll": "Reinitialisation en cours...",
      "settings.resetAllSuccess": "Toutes les donnees ont ete reinitialisees",
      ...
      "sort.cmpAsc": "CMP croissant",
      "sort.cmpDesc": "CMP decroissant",
      "sort.valueAsc": "Valeur croissante",
      "sort.valueDesc": "Valeur decroissante",
      "sort.statusAsc": "Statut critique d'abord",
      "sort.statusDesc": "Statut OK d'abord",
      "status.low": "Bas",
      "status.ok": "OK",
      ...
      "time.yesterday": "Hier",
      "tooltip.kpiQonto": "Solde du compte courant Qonto - cliquer pour ouvrir Qonto",
      "tooltip.kpiStock": "Ouvrir le catalogue trié par stock",
      "tooltip.kpiValue": "Ouvrir le catalogue trié par valeur",
      "tooltip.printLatestOrder": "Ouvre le modal d'étiquettes pré-rempli avec les pochons de cette commande",
      "tooltip.refreshLatestOrder": "Recharger la dernière commande Shopify",
    ...
    en: {
      "manualSales.cancelLine": "Cancel this line (restocks inventory)",
      "manualSales.cancelOrder": "Cancel sale (restock inventory)",
      "manualSales.cancelOrderConfirm": "Cancel this manual sale?",
      "manualSales.cancelLineConfirm": "Cancel this line?",
      "manualSales.cancelRestitue": "Inventory will be credited back by",
      "manualSales.cancelConfirmBtn": "Cancel sale",
      "manualSales.cancelError": "Cancellation failed",
      "manualSales.cancelDone": "Sale cancelled, inventory restocked",
      "action.add": "Add",
      ...
      "analytics.manualSales": "Manual sales",
      "manualSales.noSales": "No manual sales",
      "manualSales.noSalesDesc": "Sales made in-store or delivery will appear here.",
      "manualSales.count": "Sales",
      "manualSales.revenue": "Revenue",
      "manualSales.cost": "Cost",
      "manualSales.margin": "Margin",
      "manualSales.volume": "Volume",
      "manualSales.date": "Date",
      "manualSales.product": "Product",
      "manualSales.qty": "Quantity",
      "analytics.ordersRecap": "Orders recap",
      "ordersDebug.noOrders": "No orders in this period",
      "ordersDebug.detectDups": "Detect duplicates",
      "ordersDebug.noDups": "No duplicates found",
      "ordersDebug.cleaning": "Cleaning up...",
      "ordersDebug.cleanupTitle": "Analytics cleanup",
      "ordersDebug.onlyDups": "Remove duplicates only",
      "ordersDebug.dupsAndSelected": "Remove duplicates + selected",
      ...
      "analytics.topVolume": "Top Volume",
      "analytics.treasury": "Treasury",
      "analytics.treasury.cached": "15min cache",
      "analytics.treasury.cashPlusStock": "cash + stock",
      "analytics.treasury.credits": "Inflows",
      "analytics.treasury.currentBalance": "Qonto balance",
      "analytics.treasury.dailyCashflow": "Daily cashflow",
      "analytics.treasury.debits": "Outflows",
      "analytics.treasury.gap": "Gap (fees + lag)",
      "analytics.treasury.loading": "Loading Qonto...",
      "analytics.treasury.movements": "movements",
      "analytics.treasury.netVariation": "Net variation",
      "analytics.treasury.noMovements": "No movement in the period",
      "analytics.treasury.notConfiguredHint": "Add QONTO_LOGIN and QONTO_SECRET_KEY to your Render environment variables to enable this view.",
      "analytics.treasury.notConfiguredTitle": "Qonto not configured",
      "analytics.treasury.onPeriod": "over the period",
      "analytics.treasury.openQonto": "Open Qonto",
      "analytics.treasury.patrimoineEvolution": "Total assets evolution",
      "analytics.treasury.patrimoineEvolutionHint": "Reconstructed from current state + cashflow + stock movements",
      "analytics.treasury.perDay": "day",
      "analytics.treasury.period": "Period",
      "analytics.treasury.processorGapNote": "Approximation: Shopify Payments payouts arrive with a 2-3 day delay and include refunds. The shorter the period, the less reliable the figure.",
      "analytics.treasury.processorGapTitle": "Payment processor fees (Shopify Payments)",
      "analytics.treasury.product": "product",
      "analytics.treasury.products": "products",
      "analytics.treasury.runRate": "Monthly run-rate",
      "analytics.treasury.shopifyGross": "Shopify gross revenue",
      "analytics.treasury.shopifyPayouts": "Received in Qonto (Shopify)",
      "analytics.treasury.stockValue": "Stock value (avg cost)",
      "analytics.treasury.topCredits": "Top inflows",
      "analytics.treasury.topDebits": "Top outflows",
      "analytics.treasury.totalAssets": "Total assets",
      "analytics.treasury.transaction": "transaction",
      "analytics.treasury.transactions": "transactions",
      "analytics.treasury.transactionsFetched": "transactions fetched",
      "analytics.treasury.unavailableTitle": "Qonto API unavailable",
      "analytics.treasury.updatedAt": "Updated",
      ...
      "dashboard.latestOrder.empty": "No recent Shopify order.",
      "dashboard.latestOrder.emptyHint": "Labels will appear here as soon as an order arrives.",
      "dashboard.latestOrder.error": "Could not load the latest order.",
      "dashboard.latestOrder.newOrder": "New order ready to label",
      "dashboard.latestOrder.noProducts": "Products not found in local catalog.",
      "dashboard.latestOrder.notInCatalog": "missing from catalog",
      "dashboard.latestOrder.pouchMany": "pouches",
      "dashboard.latestOrder.pouchOne": "pouch",
      "dashboard.latestOrder.printBtn": "Print labels",
      "dashboard.latestOrderLabels": "Latest order label",
      ...
      "dashboard.qontoBalance": "Qonto balance",
      ...
      "filter.noMatch": "No products match the active filters.",
      "filter.reset": "Reset",
      "filter.status": "Status",
      "filter.statusCritical": "Out of stock / critical",
      "filter.statusLow": "Low stock",
      "filter.statusOk": "In stock",
      ...
      "labels.lot": "Batch",
      "labels.allLots": "All active batches",
      "labels.quantity": "Number of labels",
      "labels.weight": "Weight per pouch",
      "labels.weightAuto": "Auto from batch",
      "labels.format": "Format",
      "labels.price": "Selling price",
      "labels.optional": "Optional",
      "labels.customLine": "Custom line",
      "labels.showQR": "Traceability QR code",
      "labels.showPrice": "Show price",
      "labels.showSupplierRef": "Supplier ref.",
      "labels.selectProduct": "Select a product to generate preview",
      "labels.preview": "Preview",
      "labels.print": "Print",
      "labels.printTitle": "Labels",
      "labels.labelCount": "label(s)",
      "labels.previewNote": "Preview limited to 4. All {count} will print.",
      "labels.popupBlocked": "Popup blocked - allow popups to print",
      "labels.addLabel": "Add",
      "labels.giftAdd": "Gift pouch",
      "labels.giftBadge": "Gift pouch",
      "labels.giftHint": "The cost (avg) will count toward order margin, with no revenue. Stock will be decremented at print time.",
      "labels.giftPriceDisabled": "Price not applicable on a gift pouch",
      "labels.giftSaved": "{count} gift line(s) saved",
      "labels.giftFailed": "{count} gift line(s) not saved",
      "labels.giftNoOrder": "Gift pouch ignored (unknown order).",
      "labels.labelNum": "Label",
      "labels.previewTotal": "{count} label(s) total on the sheet",
      "labels.productTypes": "different products",
      ...
      "orders.uploadInvoice": "Upload a purchase invoice",
      "orders.uploadFormats": "PDF - Text will be extracted and analyzed automatically",
      "orders.analyzing": "Extracting text...",
      "orders.invoiceAnalyzed": "Invoice analyzed - {count} line(s) detected",
      "orders.analysisFailed": "Analysis failed",
      "orders.manualEntry": "Enter lines manually below.",
      "orders.imageUploaded": "Image loaded. Enter lines manually.",
      "orders.pdfLibError": "Unable to load PDF reader.",
      "orders.showExtracted": "Show extracted text",
      ...
      "products.confirmDelete": "Permanently delete this product from stock?",
      "products.confirmDeleteWarn": "This action is irreversible. Movement history will be preserved.",
      "products.deleted": "Product deleted from stock",
      "products.selected": "selected",
      "products.deleteSelected": "Delete selection",
      "products.confirmDeleteMultiple": "Delete {count} product(s) from stock?",
      "products.deletingMultiple": "Deleting...",
      "products.deletedCount": "product(s) deleted",
      "products.note": "Note",
      ...
      "sale.title": "Manual sale",
      "sale.manualInfo": "Sale outside Shopify",
      "sale.manualDesc": "Record a sale made in-store, market or delivery. Stock will be deducted and the sale tracked in analytics.",
      "sale.product": "Product",
      "sale.quantity": "Quantity sold",
      "sale.sellingPrice": "Total selling price",
      "sale.customer": "Customer",
      "sale.customerPlaceholder": "Customer name or order ref.",
      "sale.note": "Note",
      "sale.notePlaceholder": "E.g. Counter sale, market, delivery...",
      "sale.confirm": "Record sale",
      "sale.costPrice": "Cost price",
      "sale.margin": "Margin",
      "sale.success": "Sale recorded",
      "sale.products": "Products sold",
      "sale.addProduct": "Add a product",
      "sale.addAtLeastOne": "Add at least one product",
      "sale.qtyMissing": "Quantity missing on line: ",
      "sale.productMissing": "Select a product on each line",
      "sale.quantityPh": "Qty",
      "sale.totalLockedTitle": "Total computed from per-line prices",
      "sale.priceRequired": "Enter the selling price",
      "sale.stockWarning": "Insufficient stock for some products:",
      "sale.continueAnyway": "Continue anyway?",
      "sale.processing": "Processing...",
      "sale.printLabels": "Order labels",
      "sale.labelsReady": "{count} label(s) ready to print.",
      "sale.skipLabels": "Skip",
      "sale.insufficientStock": "Insufficient stock ({stock}) for requested quantity ({qty}). Continue?",
      "dashboard.manualSale": "Manual sale",
      "search.close": "Close",
      ...
      "settings.createSnapshot": "Create point",
      "settings.viewSnapshots": "View / Restore",
      "settings.snapshotLabel": "Restore point name (optional):",
      "settings.creatingSnapshot": "Creating restore point...",
      "settings.snapshotCreated": "Restore point created!",
      "settings.noSnapshots": "No restore points available.",
      "settings.noSnapshotsHint": "Create a point to be able to go back.",
      "settings.restoreSnapshot": "Restore",
      "settings.confirmRollback": "Restore data to point:",
      "settings.confirmRollbackWarn": "An automatic backup will be created before restoration. Continue?",
      "settings.rollingBack": "Restoring...",
      "settings.rollbackSuccess": "Data restored successfully!",
      "settings.confirmDeleteSnapshot": "Delete this restore point?",
      "settings.snapshotDeleted": "Point deleted",
      "settings.dangerZone": "Danger zone",
      "settings.dangerZoneDesc": "These actions are irreversible and will permanently delete your data.",
      "settings.resetAllData": "Reset all data",
      "settings.confirmResetAll1": "WARNING: This will delete ALL your data (products, stock, movements, settings).\n\nAn automatic restore point will be created before deletion.\n\nAre you sure?",
      "settings.confirmResetAll2": "To confirm, type RESET in capitals:",
      "settings.resetCancelled": "Reset cancelled",
      "settings.resettingAll": "Resetting...",
      ...
      "sort.cmpAsc": "CMP ascending",
      "sort.cmpDesc": "CMP descending",
      "sort.valueAsc": "Value ascending",
      "sort.valueDesc": "Value descending",
      "sort.statusAsc": "Critical first",
      "sort.statusDesc": "OK first",
      ...
      "tooltip.kpiQonto": "Qonto current account balance - click to open Qonto",
      "tooltip.kpiStock": "Open catalog sorted by stock",
      "tooltip.kpiValue": "Open catalog sorted by value",
      "tooltip.printLatestOrder": "Opens the labels modal pre-filled with this order's pouches",
      "tooltip.refreshLatestOrder": "Reload the latest Shopify order",
