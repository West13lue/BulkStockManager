...
var I18N = {
  ...
  translations: {
    ...
    fr: {
      ...
      "notifications.settings": "Parametres",
      "notifications.refresh": "Actualiser",
      "notifications.markAllRead": "Tout marquer lu",
      "notifications.dismiss": "Ignorer",
      "notifications.allMarkedRead": "Tout marque comme lu",
      "notifications.checking": "Verification en cours...",
      "notifications.checked": "Verification terminee",
      "notifications.newAlerts": "nouvelle(s) alerte(s)",
      "notifications.enabled": "Notifications activees",
      "notifications.stockAlerts": "Alertes de stock",
      "notifications.outOfStock": "Rupture de stock",
      "notifications.criticalStock": "Stock critique",
      "notifications.lowStock": "Stock bas",
      "notifications.expiryAlerts": "Alertes DLC / Lots",
      "notifications.lotExpired": "Lot expire",
      "notifications.expiring7": "Expire dans 7 jours",
      "notifications.expiring15": "Expire dans 15 jours",
      "notifications.expiring30": "Expire dans 30 jours",
      "notifications.forecastAlerts": "Alertes previsions",
      "notifications.forecastCritical": "Rupture prevue (<7j)",
      "notifications.forecastUrgent": "Stock urgent (<14j)",
      "notifications.actions": "Actions",
      "notifications.checkNow": "Verifier maintenant",
      "notifications.lockedDesc": "Les alertes et notifications sont disponibles avec le plan Pro.",
      
      // Profils utilisateurs
      "profiles.whoIsConnecting": "Qui se connecte ?",
      "profiles.welcome": "Bienvenue",
      "profiles.createNew": "Nouveau profil",
      "profiles.createProfile": "Creer un profil",
      "profiles.name": "Nom",
      ...
      "profiles.updated": "Profil mis a jour",
      ...
      "profiles.manageProfiles": "Gerer les profils",
    ...
    en: {
      ...
      "notifications.checked": "Check complete",
      "notifications.newAlerts": "new alert(s)",
      "notifications.enabled": "Notifications enabled",
      "notifications.stockAlerts": "Stock alerts",
      "notifications.outOfStock": "Out of stock",
      "notifications.criticalStock": "Critical stock",
      "notifications.lowStock": "Low stock",
      "notifications.expiryAlerts": "Expiry / Batch alerts",
      "notifications.lotExpired": "Batch expired",
      "notifications.expiring7": "Expires in 7 days",
      "notifications.expiring15": "Expires in 15 days",
      "notifications.expiring30": "Expires in 30 days",
      "notifications.forecastAlerts": "Forecast alerts",
      "notifications.forecastCritical": "Stockout predicted (<7d)",
      "notifications.forecastUrgent": "Urgent stock (<14d)",
      "notifications.actions": "Actions",
      "notifications.checkNow": "Check now",
      "notifications.lockedDesc": "Alerts and notifications are available with the Pro plan.",
