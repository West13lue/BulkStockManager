...
(function() {
  ...
  var translations = {
    fr: {
      ...
      "action.restock": "RÃƒÆ’Ã‚Â©appro",
      "action.retry": "RÃƒÆ’Ã‚Â©essayer",
      "action.save": "Enregistrer",
      "action.search": "Rechercher",
      "action.selectProduct": "SÃƒÆ’Ã‚Â©lectionner...",
      ...
      "dashboard.quickRestock": "RÃƒÆ’Ã‚Â©appro rapide",
      ...
      "msg.restockSuccess": "RÃƒÆ’Ã‚Â©appro effectuÃƒÆ’Ã‚Â©e",
      "msg.saving": "Enregistrement...",
      "msg.selectProduct": "SÃƒÆ’Ã‚Â©lectionnez un produit",
      ...
      "profiles.createProfile": "CrÃƒÆ’Ã‚Â©er un profil",
      ...
      "reason.damage": "Produit endommagÃƒÆ’Ã‚Â©",
      "reason.theft": "Vol/Perte",
      "scanner.barcodePlaceholder": "Code-barres...",
      "scanner.cameraError": "Erreur camÃƒÆ’Ã‚Â©ra",
      "scanner.cameraInUse": "La camÃƒÆ’Ã‚Â©ra est utilisÃƒÆ’Ã‚Â©e par une autre application.",
      "scanner.enterBarcode": "Entrez un code-barres",
      "scanner.howToEnable": "Comment activer la camÃƒÆ’Ã‚Â©ra :",
      "scanner.httpsRequired": "HTTPS requis pour accÃƒÆ’Ã‚Â©der ÃƒÆ’Ã‚Â  la camÃƒÆ’Ã‚Â©ra",
      "scanner.iframeBlocked": "La camÃƒÆ’Ã‚Â©ra est bloquÃƒÆ’Ã‚Â©e par le navigateur.",
      "scanner.initializing": "Initialisation camÃƒÆ’Ã‚Â©ra...",
      "scanner.manualEntry": "Ou saisir manuellement",
      "scanner.manualOnly": "DÃƒÆ’Ã‚Â©tection auto non supportÃƒÆ’Ã‚Â©e - utilisez la saisie manuelle",
      "scanner.noCameraFound": "Aucune camÃƒÆ’Ã‚Â©ra dÃƒÆ’Ã‚Â©tectÃƒÆ’Ã‚Â©e sur cet appareil.",
      "scanner.notFound": "Produit non trouvÃƒÆ’Ã‚Â©",
      "scanner.notFoundHint": "VÃƒÆ’Ã‚Â©rifiez que le code-barres est configurÃƒÆ’Ã‚Â© sur le produit dans Shopify.",
      "scanner.notFoundMsg": "Aucun produit trouvÃƒÆ’Ã‚Â© avec le code",
      "scanner.notSupported": "CamÃƒÆ’Ã‚Â©ra non supportÃƒÆ’Ã‚Â©e sur ce navigateur",
      "scanner.permissionDenied": "AccÃƒÆ’Ã‚Â¨s camÃƒÆ’Ã‚Â©ra refusÃƒÆ’Ã‚Â©. Autorisez l'accÃƒÆ’Ã‚Â¨s dans les paramÃƒÆ’Ã‚Â¨tres.",
      "scanner.productFound": "Produit trouvÃƒÆ’Ã‚Â©!",
      "scanner.ready": "CamÃƒÆ’Ã‚Â©ra prÃƒÆ’Ã‚Âªte - PrÃƒÆ’Ã‚Â©sentez un code-barres",
      "scanner.requesting": "Demande d'accÃƒÆ’Ã‚Â¨s ÃƒÆ’Ã‚Â  la camÃƒÆ’Ã‚Â©ra...",
      "scanner.scanAgain": "Scanner ÃƒÆ’Ã‚Â  nouveau",
      "scanner.securityError": "AccÃƒÆ’Ã‚Â¨s camÃƒÆ’Ã‚Â©ra bloquÃƒÆ’Ã‚Â© par les paramÃƒÆ’Ã‚Â¨tres de sÃƒÆ’Ã‚Â©curitÃƒÆ’Ã‚Â©.",
      "scanner.startCamera": "DÃƒÆ’Ã‚Â©marrer la camÃƒÆ’Ã‚Â©ra",
      "scanner.step1": "Cliquez sur l'icÃƒÆ’Ã‚Â´ne camÃƒÆ’Ã‚Â©ra/cadenas dans la barre d'adresse",
      "scanner.step2": "Autorisez l'accÃƒÆ’Ã‚Â¨s ÃƒÆ’Ã‚Â  la camÃƒÆ’Ã‚Â©ra pour ce site",
      "scanner.step3": "Rechargez la page si nÃƒÆ’Ã‚Â©cessaire",
      "scanner.tapToStart": "Touchez la vidÃƒÆ’Ã‚Â©o pour dÃƒÆ’Ã‚Â©marrer",
      ...
      "settings.resetTutorialsBtn": "RÃƒÆ’Ã‚Â©initialiser",
      ...
      "shortcuts.closeModal": "Fermer fenÃƒÆ’Ã‚Âªtre",
      ...
      "shortcuts.quickRestock": "RÃƒÆ’Ã‚Â©appro rapide",
      ...
      "tutorial.analytics.step1": "Visualisez la rÃƒÆ’Ã‚Â©partition de votre stock par catÃƒÆ’Ã‚Â©gorie.",
      "tutorial.analytics.step2": "Suivez l'ÃƒÆ’Ã‚Â©volution de la valeur de votre inventaire.",
      ...
      "tutorial.batches.step1": "GÃƒÆ’Ã‚Â©rez les dates de pÃƒÆ’Ã‚Â©remption de vos produits.",
      "tutorial.batches.step2": "Recevez des alertes pour les lots qui arrivent ÃƒÆ’Ã‚Â  expiration.",
      "tutorial.batches.step3": "Suivez la traÃƒÆ’Ã‚Â§abilitÃƒÆ’Ã‚Â© de chaque lot entrant.",
      "tutorial.batches.tip": "Les lots expirÃƒÆ’Ã‚Â©s sont automatiquement signalÃƒÆ’Ã‚Â©s en rouge.",
      "tutorial.batches.title": "Lots et DLC",
      "tutorial.dashboard.step1": "Visualisez vos statistiques clÃƒÆ’Ã‚Â©s : nombre de produits, stock total et valeur.",
      "tutorial.dashboard.step2": "Les alertes vous signalent les produits en stock bas ou en rupture.",
      "tutorial.dashboard.step3": "Utilisez les actions rapides pour rÃƒÆ’Ã‚Â©appro, scanner ou ajuster le stock.",
      "tutorial.dashboard.step4": "Les mouvements rÃƒÆ’Ã‚Â©cents montrent l'activitÃƒÆ’Ã‚Â© de votre stock.",
      ...
      "tutorial.forecast.step2": "Anticipez les ruptures grÃƒÆ’Ã‚Â¢ce aux prÃƒÆ’Ã‚Â©visions.",
      "tutorial.forecast.step3": "Recevez des suggestions de rÃƒÆ’Ã‚Â©approvisionnement.",
      "tutorial.forecast.tip": "Plus vous avez d'historique, plus les prÃƒÆ’Ã‚Â©visions sont prÃƒÆ’Ã‚Â©cises.",
      "tutorial.forecast.title": "PrÃƒÆ’Ã‚Â©visions",
      "tutorial.inventory.step1": "CrÃƒÆ’Ã‚Â©ez des sessions d'inventaire complet ou partiel.",
      "tutorial.inventory.step2": "Utilisez le scanner pour compter plus rapidement.",
      "tutorial.inventory.step3": "Comparez le stock thÃƒÆ’Ã‚Â©orique vs rÃƒÆ’Ã‚Â©el et validez les ÃƒÆ’Ã‚Â©carts.",
      "tutorial.inventory.tip": "Planifiez des inventaires rÃƒÆ’Ã‚Â©guliers pour une meilleure prÃƒÆ’Ã‚Â©cision.",
      "tutorial.inventory.title": "Inventaire",
      "tutorial.kits.step1": "CrÃƒÆ’Ã‚Â©ez des kits composÃƒÆ’Ã‚Â©s de plusieurs produits.",
      "tutorial.kits.step2": "Le stock des composants est automatiquement dÃƒÆ’Ã‚Â©duit.",
      ...
      "tutorial.orders.step1": "CrÃƒÆ’Ã‚Â©ez des bons de commande vers vos fournisseurs.",
      "tutorial.orders.step2": "Suivez l'ÃƒÆ’Ã‚Â©tat de vos commandes en cours.",
      "tutorial.orders.step3": "RÃƒÆ’Ã‚Â©ceptionnez les commandes pour mettre ÃƒÆ’Ã‚Â  jour le stock automatiquement.",
      ...
      "tutorial.products.step2": "Filtrez par catÃƒÆ’Ã‚Â©gorie et triez selon vos besoins.",
      "tutorial.products.step3": "Utilisez le scanner pour trouver un produit rapidement.",
      "tutorial.products.step4": "Cliquez sur un produit pour voir ses dÃƒÆ’Ã‚Â©tails et ajuster le stock.",
      "tutorial.products.tip": "Astuce : Raccourci N pour ajouter un produit, R pour rÃƒÆ’Ã‚Â©appro rapide !",
      "tutorial.products.title": "Gestion des Produits",
      "tutorial.quickGuide": "Guide rapide",
      "tutorial.reset": "Tutoriels rÃƒÆ’Ã‚Â©initialisÃƒÆ’Ã‚Â©s",
      "tutorial.resetAll": "RÃƒÆ’Ã‚Â©initialiser tout",
      "tutorial.seen": "Vu",
      "tutorial.settings.step1": "Configurez la langue et les unitÃƒÆ’Ã‚Â©s de mesure.",
      "tutorial.settings.step2": "Personnalisez vos seuils d'alerte de stock.",
      "tutorial.settings.step3": "Adaptez l'interface ÃƒÆ’Ã‚Â  vos prÃƒÆ’Ã‚Â©fÃƒÆ’Ã‚Â©rences.",
      "tutorial.settings.tip": "Sauvegardez vos paramÃƒÆ’Ã‚Â¨tres pour les restaurer facilement.",
      "tutorial.settings.title": "ParamÃƒÆ’Ã‚Â¨tres",
      "tutorial.suppliers.step1": "Centralisez les informations de vos fournisseurs.",
      "tutorial.suppliers.step2": "Gardez leurs contacts et conditions ÃƒÆ’Ã‚Â  portÃƒÆ’Ã‚Â©e de main.",
      "tutorial.suppliers.step3": "Associez les produits ÃƒÆ’Ã‚Â  leurs fournisseurs pour un suivi optimal.",
      "tutorial.suppliers.tip": "Ajoutez les dÃƒÆ’Ã‚Â©lais de livraison pour anticiper vos commandes.",
